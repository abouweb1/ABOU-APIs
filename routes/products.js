...
router.get('/activeProducts', (req, res) => productControllers.getActiveProduct(req, res));

router.get('/allProducts', (req, res) => productControllers.getAllProduct(req, res));

router.get('/getHeroSecProducts', (req, res) => productControllers.getHeroSectionProduct(req, res));
